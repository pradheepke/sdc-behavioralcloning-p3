...
model_output_root = 'out-dropout-0.5-epochs-20/'
lines = []
...
filepath=model_output_root + "model-impr-{epoch:02d}-{val_mean_squared_error:.4f}.h5"
...
model.save(model_output_root + 'model.h5')
